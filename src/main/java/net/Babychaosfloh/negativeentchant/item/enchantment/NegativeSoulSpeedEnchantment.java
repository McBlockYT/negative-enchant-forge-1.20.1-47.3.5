...
public class NegativeSoulSpeedEnchantment extends Enchantment{
    public NegativeSoulSpeedEnchantment(Enchantment.Rarity pRarity, EquipmentSlot... pApplicableSlots) {
