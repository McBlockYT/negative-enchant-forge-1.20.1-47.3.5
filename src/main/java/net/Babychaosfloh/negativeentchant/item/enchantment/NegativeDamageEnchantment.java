...
public class NegativeDamageEnchantment extends Enchantment {
    ...
    public NegativeDamageEnchantment(Enchantment.Rarity pRarity, int pType, EquipmentSlot... pApplicableSlots) {
