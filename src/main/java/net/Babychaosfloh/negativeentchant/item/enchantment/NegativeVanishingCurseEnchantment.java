...
public class NegativeVanishingCurseEnchantment extends Enchantment {
    public NegativeVanishingCurseEnchantment(Rarity pRarity, EquipmentSlot[] pApplicableSlots) {
