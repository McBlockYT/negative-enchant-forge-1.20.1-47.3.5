...
public class ReversedSoulSpeedEnchantment extends Enchantment{
    public ReversedSoulSpeedEnchantment(Enchantment.Rarity pRarity, EquipmentSlot... pApplicableSlots) {
