...
public class ReversedDamageEnchantment extends Enchantment {
    ...
    public ReversedDamageEnchantment(Enchantment.Rarity pRarity, int pType, EquipmentSlot... pApplicableSlots) {
